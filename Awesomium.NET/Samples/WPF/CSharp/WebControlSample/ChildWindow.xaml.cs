 ...
 *    
 *    This class also demonstrates usage of the INavigationInterceptor
 *    service.
 *    
 *    
 ********************************************************************************/
...
namespace WebControlSample
{
    ...
    public partial class ChildWindow : Window
    {
        ...
        private void OnBeginNavigation( object sender, NavigationEventArgs e )
        {
            ...
            // prevent firing a download for ZIP files.
        ...
        private void OnWebControlKeyDown( object sender, KeyEventArgs e )
        {
            ...
            // This will prevent for example to enter any text in a 
            // contentEditable, but not in a text input.
