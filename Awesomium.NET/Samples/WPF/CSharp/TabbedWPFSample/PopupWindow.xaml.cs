...
namespace TabbedWPFSample
{
    ...
    /// </summary>
    partial class PopupWindow : MetroWindow
    {
        public PopupWindow( IntPtr nativeView, MainWindow parentWindow )
        {
            InitializeComponent();

            this.NativeView = nativeView;

            // Let the child TabView access the opener
            // application window.
            tabView.ParentWindow = parentWindow;
