...
namespace TabbedWPFSample
{
    ...
    class TabView : Control
    {
        ...
        public TabView()
        {
            // Controls the IsEnabled of the WebControl.
        ...
        private void OnShowNewView( object sender, ShowCreatedWebViewEventArgs e )
        {
            ...
            if ( e.IsPopup && !e.IsUserSpecsOnly )
            {
                ...
                PopupWindow newWindow = new PopupWindow( e.NewViewInstance, ParentWindow )
                {
        ...
        private void OnWindowClose( object sender, WindowCloseEventArgs e )
        {
            if ( IsRegularTab )
            {
                ...
                this.ParentWindow.ShowMessageAsync(
                    Browser.HasTitle ? Browser.Title : Browser.Source.AbsoluteUri,
                    "The page is asking to close this tab. Do you confirm?",
                    MessageDialogStyle.AffirmativeAndNegative ).ContinueWith( x =>
                    {
        ...
        private void OnDomReady( object sender, DocumentReadyEventArgs e )
        {
