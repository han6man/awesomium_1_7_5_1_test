...
namespace TabbedWPFSample
{
    ...
    class SplitButton : ContentControl, ICommandSource
    {
        ...
        public static readonly DependencyProperty ButtonToolTipProperty =
            DependencyProperty.Register( "ButtonToolTip",
            typeof( object ), typeof( SplitButton ),
            new FrameworkPropertyMetadata( null, ButtonToolTipChanged ) );

        private static void ButtonToolTipChanged( DependencyObject d, DependencyPropertyChangedEventArgs e )
        {
            SplitButton owner = (SplitButton)d;
